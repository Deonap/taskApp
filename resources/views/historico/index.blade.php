            ...
            <div class="container mx-auto px-4">
                ...
                <div class="container mx-auto px-4">
                    <div id="tabelaProjetosAbertos" class="mb-8">
                        <div class="relative">
                            <div class="bg-[#921111] text-white p-4 rounded-t-lg">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-[#d5d4d5]">
                                    <tr>
                                        <th scope="col" class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">
                                            Nº
                                        </th>
                                        <th scope="col" class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">
                                            Cliente
                ...
                <div class="container mx-auto px-4">
                    <div id="tabelaProjetosPendentes" class="mb-8">
                        <div class="relative">
                            <div class="bg-[#311fbd] text-white p-4 rounded-t-lg">
