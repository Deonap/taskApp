            ...
            .then(data => {
                ...
                data.projetos.forEach((projeto) => {
                    ...
                    if(true){
                        ...
                        if(userProjeto){
                            observacoes = userProjeto.pivot.observacoes ? userProjeto.pivot.observacoes : '';
                        }
                        ...
                        <div class="flex justify-center items-center space-x-4">
                            ...
                            <form action="/projetos/${projeto.id}/destroy" method="POST" class="m-0" onsubmit="return confirm('Tem a certeza?')">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="user" value="${userProjeto.id}">
                                <input type="hidden" name="origin" value="${userProjeto.id}">
                        ...
                        celulaAcoes.innerHTML.replaceAll(':idProjeto',projeto.id);
            ...
            .then(data => {
                ...
                data.projetos.forEach((projeto) => {
                    ...
                    if(true){
                        ...
                        celulaAcoes.innerHTML.replaceAll(':projetoId', projeto.id);
