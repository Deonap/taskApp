                    ...
                    <tbody>
                        ...
                        @foreach ($estados as $estado)
                            <tr class="border-b">
                                ...
                                <td>
                                    <form action="{{ route('estado-projetos.update', $estado->id) }}" class="size-6 w-full text-center" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input class="w-6" id="cor" type="color" onchange="this.form.submit()" name="cor" value="{{ $estado->cor }}">
                                    </form>
                                </td>
                                <td>
